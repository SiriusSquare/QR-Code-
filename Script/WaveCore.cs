...
public class WaveCore : MonoBehaviour
{
    ...
    private IEnumerator WaveStart()
    {
        switch (wavecount)
        {
            ...
            case 2:
                StopAmbientMusic();
                PlayMusic(musicPrefab);
                InstantiateWave(Wave2);
                break;
            case 3:
                StopAmbientMusic();
                PlayMusic(musicPrefab);
                InstantiateWave(Wave3);
                break;
            case 4:
                StopAmbientMusic();
                PlayMusic(musicPrefab);
    ...
    private void StopAmbientMusic(bool destroyPrefab = false)
    {
        ...
        if (destroyPrefab && ambientMusicPrefab != null)
        {
            Destroy(ambientMusicPrefab);
            ambientMusicPrefab = null;
        }
    }
